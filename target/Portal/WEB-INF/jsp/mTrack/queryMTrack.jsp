...
<link href="${pageContext.request.contextPath}/assets/css/dropzone.css" type="text/css" rel="stylesheet" />
<script src="${pageContext.request.contextPath}/assets/js/myuploadfunction.js"></script>
...
<!-- /////////////////// Page Content Started from here /////////////////// -->
	...
	<div class="tabbable">
		<ul class="nav nav-tabs" id="myTab">
			<li class="active"><a href="#dragdrop">Landing Zone</a></li>
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="dragdrop">
                ...
                <div class="row-fluid">
					...
					<input id="fileupload" type="file" name="files[]" data-url="uploadDD" multiple>
                	...
                	<form method="POST" name="batchMtrackBilling" id="batchMtrackBilling" action="batchMtrackBilling" enctype="multipart/form-data">
						...
						<div class="row-fluid">
							<div class="span9">
								...
								<input type="file" name="batchFile" id="batchFile" class="text ui-widget-content ui-corner-all" />
